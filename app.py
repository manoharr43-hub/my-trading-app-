...
st.title("📊 NSE AI PRO V23.9 - Backtest Engine")
...
if st.button("📂 RUN BACKTEST"):
    ...
    if all_signals:
        st.write(f"### 📂 Backtest Results ({bt_date})")
        bt_results_df = pd.DataFrame(all_signals)
    ...
    st.download_button(
        ...
        data=csv_data,
        file_name=f"Backtest_{bt_date}.csv",
        mime="text/csv"
    )
