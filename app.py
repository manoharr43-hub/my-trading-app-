...
def process_logic(df, ticker=""):
    ...
    try:
        ...
        temp_df['RSI'] = get_rsi(temp_df['Close'])
        ...
        if ltp > res and ltp > vwap_val and rsi_val > 55:
            ...
            status, bg = "⚠️ FAKE MOVE / NO MOMENTUM", "#fff3cd"
...
if search_q:
    ...
    if not s_data.empty:
        ...
        if res_s:
            ...
            c4.metric("Trend", res_s['Trend_15m'])
...
if table_results:
    ...
    st.table(df_f[['Stock', 'LTP', 'VWAP', 'RSI', 'Signal', 'Status']].style.apply(
